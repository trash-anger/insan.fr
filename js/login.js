  ...
  var options = {
    ...
    languageDictionary: {
      error: {
        forgotPassword: {
          too_many_requests: 'Tu as atteint la limite de tentatives de changement de mot de passe. Patiente avant de recommencer.',
          'lock.fallback': 'Désolé, un problème est survenu lors de la demande de changement de mot de passe.',
          enterprise_email: "Le domaine de ta messagerie fait partie d'un fournisseur d'identité d'entreprise. Pour réinitialiser votre mot de passe, contacte ton administrateur de sécurité."
        },
        login: {
          blocked_user: 'L’utilisateur est bloqué.',
          invalid_user_password: 'Mauvais identifiants.',
          'lock.fallback': 'Désolé, un problème est survenu lors de la tentative de connexion.',
          ...
          'lock.network': 'Serveur injoignable. Vérifie ta connexion et réessaye.',
          ...
          password_change_required: 'Tu dois mettre à jour ton mot de passe, soit parce qu’il s’agit de ta première connexion, soit parce que ce dernier a expiré.',
          password_leaked: 'Cette connexion a été bloquée parce que ton mot de passe a été utilisé sur un autre site web. Je t\'ai envoyé un courriel avec des instructions pour la débloquer.',
          too_many_attempts: 'Ton compte a été bloqué à la suite de trop nombreuses tentatives de connexion consécutives.',
          'lock.mfa_registration_required': "l'authentification multifactorielle est nécessaire, mais ton appareil n'est pas inscrit. Inscris toi avant de passer.",
          'lock.mfa_invalid_code': 'Mauvais code. Réessaye.',
          session_missing: "Impossible de terminer ta demande d'authentification. Essaye de nouveau après la fermeture de tous les dialogues ouverts",
          'hrd.not_matching_email': "Utilise ta messagerie d'entreprise pour te connecter.",
          too_many_requests: 'Désolé. Il y a trop de demandes en ce moment. Recharge la page et réessaye. Si cela persiste, réessaye ultérieurement.'
        },
        passwordless: {
          'bad.email': 'L’adresse de messagerie n’est pas valide',
          'bad.phone_number': 'Le numéro de téléphone n’est pas valide',
          'lock.fallback': 'Désolé, un problème est survenu'
        },
        signUp: {
          invalid_password: 'Le mot de passe n’est pas valide.',
          'lock.fallback': 'Désolé, un problème est survenu lors de la tentative d’inscription.',
      ...
      success: {
        ...
        forgotPassword: 'Je viens de t\'envoyer un courriel pour réinitialiser ton mot de passe.',
      ...
      enterpriseActiveLoginInstructions: 'Entre les identifiants de connexion de ton entreprise %s.',
      failedLabel: 'A échoué !',
      forgotPasswordAction: 'Mot de passe oublié ?',
      forgotPasswordInstructions: 'Entre ton adresse de messagerie. Je t\'enverrai un courriel pour réinitialiser ton mot de passe.',
      ...
      passwordlessEmailAlternativeInstructions: 'Sinon entre ton adresse de messagerie pour te connecter ou créez un compte',
      passwordlessEmailCodeInstructions: 'Un courriel avec le code a été envoyé à %s.',
      passwordlessEmailInstructions: 'Entre ton adresse de messagerie pour te connecter ou créez un compte',
      passwordlessSMSAlternativeInstructions: 'Sinon saisisse ton numéro de téléphone pour te connecter ou créez un compte',
      passwordlessSMSCodeInstructions: 'Un SMS avec le code a été envoyé à %s.',
      passwordlessSMSInstructions: 'Saisisse ton numéro de téléphone pour te connecter ou créez un compte',
      ...
      mfaLoginInstructions: 'Entre le code de vérification généré par ton application mobile.',
  ...
  var lockPasswordless = new Auth0LockPasswordless('P9fSxTwDWld3wdzQgVDxj2T5Y5rwyar0', 'insan.eu.auth0.com', options);
